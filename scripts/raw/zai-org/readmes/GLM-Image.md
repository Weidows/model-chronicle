...
<p align="center">
    👋 Join our <a href="https://raw.githubusercontent.com/zai-org/GLM-Image/refs/heads/main/resources/wechat.png" target="_blank">WeChat</a> and <a href="https://discord.gg/8KFjEec7" target="_blank">Discord</a> community
    <br>
    📖 Check out GLM-Image's <a href="https://z.ai/blog/glm-image" target="_blank">Technical Blog</a> and <a href="https://github.com/zai-org/GLM-Image" target="_blank">Github</a>
    <br>
...
This project incorporates the VQ tokenizer weights and VIT weights from [X-Omni/X-Omni-En](huggingface.co/X-Omni/X-Omni-En), which are licensed under the Apache License, Version 2.0.
